...
<html lang="en">
  <head>
    ...
    <link href="css/bootstrap.min.css" rel="stylesheet">
      ...
      <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA8SSYd2TMFmemJ6b_N9b6GxYWJova-0ik&libraries=places"></script>
  ...
  <div class="container-fluid" id="myContainer">
    <div class="row">
      <div style="  background-color: #00000094;" class=" col-md-8 col-md-offset-2">
        ...
        <?php
          ...
          if(!isset($_SESSION["user_id"])){
           ?>
            <button class="btn btn-lg green signup" data-toggle="modal" data-target="#signupModal">Sign up-It's free</button>
           <?php
          }
        ?>
            ...
            <div class="modal-dialog">
              ...
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" type="text" name="phonenumber" id="phonenumber" placeholder="Telephone Nuber" maxlength="30">
                  </div>
                  <div class="form-group">
