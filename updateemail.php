...
if(!$result){
    ...
    //provjeriti opet ovu adresu za localhost
$message .= "http://localhost/1php/CarSharing/activatenewemail.php?email=" . urlencode($email) . "&newemail=" . urlencode($newemail) . "&key=$activationKey";
