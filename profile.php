              ...
              <div class="navbar-collapse collapse" id="navbarCollapse">
                  ...
                  <ul class="nav navbar-nav navbar-right">
                      <li><a href="#"><div data-toggle="modal" data-target="#updatepicture">
                        <?php
                          if(empty($picture)){
                            echo "<img src='profilepicture/profile1.jpg' class='preview' >";
                          }else{
      ...
      <div class="container" id="container">
          <div class="row">
              <div class="col-md-offset-3 col-md-6">
                  ...
                  <h2 style="color:#fff">General Account Settings:</h2>
        ...
        <div class="modal" id="updatepicture" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              ...
              <div class="modal-body">
                  ...
                  <?php
                    if(empty($picture)){
                      echo "<div><img class='preview2' id='preview2' src='profilepicture/profile1.jpg'></div>";
                    }else{
