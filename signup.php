...
$missingPhoneNumber = '<p><strong>Please enter a valid phone number(digits only and less then 15 long)</strong></p>';
...
if(empty($_POST["phonenumber"])){
    $errors.=$missingPhone;
    //u zagradi primjeri imaju na www.rexegg.com
    //samo brojevi su prihvatljivi
...
$message .= "http://localhost/1php/CarSharing/activate.php?email=" . urlencode($email) . "&key=$activationKey";
